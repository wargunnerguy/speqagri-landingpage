Vue.component('traktorijuht', {
    template: `
<div id="job_vacancies_box" class="well well-large section green joboffer">
<h4>{{$t("message.we_offer_work_to")}}{{$t("message.to_tractor_driver")}}</h4>
        <div class="row">
            <div class="span3">
...
<!--                    <span class="badge badge-success notify-badge-active">{{$t("message.active")}}</span>-->
                    <picture>
                        <source srcset="assets/img/job_offer_thumbnails/Traktorijuht_NewHollandT500_360.webp" type="image/webp">
                        <source srcset="assets/img/job_offer_thumbnails/Traktorijuht_NewHollandT500_360.jpg" type="image/png">
        ...
        <div class="row">
            ...
            <div class="span6">               
                ...
                <div class="fb-share-button" data-href="https://speqagri.ee/traktorijuht.html" data-layout="button_count" data-size="large">
                    <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fspeqagri.ee%2Ftraktorijuht.html&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore" >Share
                    </a>
                </div>
            </div>
        </div>
