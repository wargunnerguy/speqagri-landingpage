...
<!--                    <span class="badge badge-success notify-badge-active">{{$t("message.active")}}</span>-->
                    <picture>
                        <source srcset="assets/img/job_offer_thumbnails/veoautojuht_360.webp" type="image/webp">
                        <source srcset="assets/img/job_offer_thumbnails/veoautojuht_360.png" type="image/png">
                ...
                <div class="row">
                    <div class="span4">
                        ...
                        <ul style="list-style-type:circle;">
                            <li>{{$t("message.cat_c_driving_license")}}</li>
                            <li>{{$t("message.proficiency_est")}}</li>
                            <li>{{$t("message.correctness_responsibility_accuracy")}}</li>
                            <li>{{$t("message.vocational_training_certificate")}}</li>
                        </ul>
                    </div>
                    <div class="span3">
        ...
        <div class="row">
            ...
            <div class="span6">               
                ...
                <div class="fb-share-button" data-href="https://speqagri.ee/veoautojuht.php" data-layout="button_count" data-size="large">
                    <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fspeqagri.ee%2Fveoautojuht.php&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">
                        Share
                    </a>
                </div>
            </div>
